...
and the severity of crash injury by 21 percent \cite{iihs_bsd}. V2V provides the possibility
to reduce common vehicular crashes by communicating warnings between connected vehicles.
