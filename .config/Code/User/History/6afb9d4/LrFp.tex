...
LED, and a red ``warning'' LED. The yellow LED turns on when there is a nearby (less than 100mm for the e)
...
There were intermittent disconnect issueso o
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{pics/term1.jpg}}
\caption{One ``vehicle'' is sending a message through UDP.}
\label{term1}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{pics/term2.jpg}}
