  ...
  if(udp.listen(10000)) {
        udp.onPacket([](AsyncUDPPacket packet) {
            ...
            */
            ...
            Serial.write(recvTempPacket.statusMessage);
            Serial.write(recvTempPacket.tofData);
            Serial.write(recvTempPacket.accelData);
            Serial.print("\n");
...
void loop() {
  ...
  if(currentTime > (sendTimer + ((unsigned long) 3000)))
  {
    ...
    udp.broadcastTo(buffer,sizeof(struct packetInfo),10000);
